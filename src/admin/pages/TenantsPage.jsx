...
function TenantList({ onSelect }) {
  ...
  useEffect(() => {
    apiFetch('/api/admin/index?route=tenants')
...
function TenantDetail({ teamId, onBack }) {
  ...
  useEffect(() => {
    apiFetch(`/api/admin/index?route=tenants&id=${teamId}`)
      .then(setData)
      .catch(e => setError(e.message))
      .finally(() => setLoading(false));
  }, [teamId]);
  ...
  async function handleDeactivate() {
    setConfirm({
      ...
      onConfirm: async () => {
        setConfirm(null);
        try {
          await apiPost('/api/admin/index?route=tenants', { teamId, active: false });
  ...
  async function handleReactivate() {
    try {
      await apiPost('/api/admin/index?route=tenants', { teamId, active: true });
